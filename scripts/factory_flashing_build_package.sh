...
echo "visteon" | sudo -S ./create_bsp_images.sh -l -r 02 -b ${bsp_s_variant}-${Hardware} -k $(readlink -f quickboot_qspi_linux_factoryflash_c5.cfg) -g ${S_SW_VARIANT}
...
cp ${WORKSPACE}/resources/1-dev-mtd-mtd0.bin ${NOR_IMAGE_FILE}
